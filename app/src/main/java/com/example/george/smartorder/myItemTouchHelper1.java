 ...
 */
public class myItemTouchHelper1 extends ItemTouchHelper.SimpleCallback {
    private ordersListAdapter myAdapter;

    public myItemTouchHelper1(ordersListAdapter mAdapter){
